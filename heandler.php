...
require_once('classes/services/Dailymotion.php');
...
print_r($dailymotion_opt);
die();

$content = file_get_contents('http://test.site/youadr.html');
...
$service = new \youtube_parser\services\Dailymotion($dailymotion_opt['api_key'], $dailymotion_opt['api_secret'], $dailymotion_opt['user'], $dailymotion_opt['pas']);
